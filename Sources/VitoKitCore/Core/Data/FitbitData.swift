...
struct Value: Codable {
    let customHeartRateZones: [JSONAny]
...
struct O2Value: Codable {
    var avg: Double
    var min, max: Int
}

struct HRVQuery: Codable {
    var hrv: [Hrv]
}
...
struct HrvValue: Codable {
    var dailyRmssd, deepRmssd: Double
}

struct RRQuery: Codable {
    var br: [Br]
}
